    ...
    <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="space-y-4">
                <div class="flex items-center space-x-2 mb-4">
                    <div class="w-10 h-10 bg-gradient-to-br from-indigo-500 to-purple-100 rounded-lg flex items-center justify-center p-2">
                        <img src="/assets/img/logo_chess-1.svg" alt="logo" height="25px" width="25px" />
>>>>>>> 7cc114c8af575ac3639440dd82412311e47c7625
                    </div>
                    <span class="text-xl font-bold text-white">Crystal Chess Arena</span>
                </div>
                <p class="text-gray-400 text-sm leading-relaxed">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="<?php echo BASE_URL; ?>/events"
                            class="text-sm text-gray-400 hover:text-indigo-400 transition-colors duration-200 flex items-center">
                            <i class="fas fa-chevron-right text-xs mr-2"></i> Browse Tournaments
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo BASE_URL; ?>/register"
        ...
        <div class="border-t border-gray-800 mt-10 pt-6">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <p class="text-sm text-gray-400">
                    &copy; <?php echo date('Y'); ?> Crystal Chess Arena. All rights reserved.
                </p>
