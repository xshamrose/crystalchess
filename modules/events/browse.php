    ...
    <div class="mb-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        ...
        <div class="flex gap-2">
            <a href="<?php echo BASE_URL; ?>/browse-events?status=upcoming" 
               class="px-4 py-2 rounded-lg text-sm font-medium transition <?= $status === 'upcoming' ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' ?>">
                <i class="fas fa-calendar-day mr-1"></i>Upcoming
            </a>
            <a href="<?php echo BASE_URL; ?>/browse-events?status=completed" 
               class="px-4 py-2 rounded-lg text-sm font-medium transition <?= $status === 'completed' ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' ?>">
                <i class="fas fa-history mr-1"></i>Past Events
            </a>
        </div>
    </div>
